...
<body background="./IMG/homepage.jpg" style="background-repeat:repeat-x;background-attachment:fixed;background-position:center center">
    <form id="form1" runat="server">
        <div>
            ...
            <div style="flex:1;border: 3px solid rgb(0, 0, 0);background-color:bisque;border-radius:6px; text-align:center;"><a href="login.aspx" style="color:rebeccapurple;"><h3>登入</h3></a></div>
            <div style="flex:1;border: 3px solid rgb(0, 0, 0);background-color:bisque;border-radius:6px; text-align:center;"><a href="register.aspx" style="color:rebeccapurple;"><h3>註冊</h3></a></div>
